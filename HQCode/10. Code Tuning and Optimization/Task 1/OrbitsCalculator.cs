...
namespace SolarSystem
{
    class OrbitsCalculator : INotifyPropertyChanged
    {
        ...
        //This remvoes the need to parse EarthRotationAngle to double!
        private const double RotationStep = 360.0;
        ...
        private void EarthRotation()
        {
            ...
            EarthRotationAngle = RotationStep * Days / EarthRotationPeriod;
